...
#figure(
  kind: "video",
  supplement: "Video",
  youtube("https://www.youtube.com/embed/cqhiup5qSY8"),
  caption: [
...
#quote(block: true, attribution: [#cite(
  <alexandreTransDayVanishing2025>,
  supplement: [13:46 - 14:45],
...
#quote(block: true, attribution: [#cite(
  <alexandreTransDayVanishing2025>,
  supplement: [15:09 - 15:16],
)])[The unique terror that defined my teen years has returned. The kind that comes when your life is completely at the whims of others, and you have no idea what they plan on doing to you.]

In slipping back into her childhood years, she's realized the political context for her childhood trauma.

#quote(block: true, attribution: [#cite(
  <alexandreTransDayVanishing2025>,
  supplement: [16:35 - 17:44, my emphasis],
)])[I used to think the converging forces of homophobia, misogyny, and Internet poisoning just happened to produce someone susceptible to grooming. …it was never a question for me that everyone in the world, no matter their political alignment, deeply regrets what happened to me. Everyone wants children to be safe. *Since landing back in this child's body, the teeth gritting realization I've come to - the one that's cost me hours of sleep - is that what happened to me was not an oversight. It was in fact the intended outcome of every policy and social norm which aims to make queerness an unspeakable matter.* People working to exclude us from public life … know that doing so will result in the grooming, abuse, and assault of queer children with nowhere else to turn.]
...
#quote(block: true, attribution: [#cite(
  <alexandreTransDayVanishing2025>,
  supplement: [44:30],
)])[Why bother to pump light into this utter blackness?
...
#quote(block: true, attribution: [#cite(
  <alexandreIveBeenLying2025a>,
  supplement: [14:27],
)])[The first several scenes mostly make a rational argument against disappearing, and it seems like that's what the video is, but then the protest happens, and the tear gas goes off, and the cops chase me down the street, and the rest of the video is driven by pure survival instinct.]
...
#media("/media/we-can-see-you.jpg", caption: link(
  "https://bsky.app/profile/bensears.bsky.social/post/3lr5lfarsts2r",
)[We Can See You - Ben Sears 2025])
...
#media("/media/glowie.png", caption: link(
  "https://x.com/polyfraggrenade/status/1893369669668556955",
)[A good post from a likely fake thread.])
