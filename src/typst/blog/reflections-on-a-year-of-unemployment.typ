...
#show: post.with(
  title: "reflections on a year of unemployment",
  description: "Life and times of your favorite estrogenized deuteragonist.",
...
<good-things-are-still-possible>
All this is not to say that I've been idle. Far from it. This entire blog was created this year, and you can see all the work I've been posting here. Admittedly, I stopped around August. I think this is when shit hit the fan and I began to really start looking more seriously for work. After I had my last hurrah with #link("/blog/architecture-2.html")[q\_service] - which I have now abandoned in favor of #link("https://github.com/ada-x64/template")[tfw] - I began the process of finding a shitjob. Obviously that didn't work out. Now, having come back from visiting my boyfriend's family in Florida for two weeks, I'm looking forward to a reset. As soon as we got home I rearranged the living room, organized the medicine cabinet, rearranged my blog. I suppose if I can't get my financial life in order I might as well get my stuff in order. Start focusing on what matters. Now that my boyfriend has picked up enough hours at work to cover rent, we have time.

I'm still hard at work on #link("/blog/general-introduction.html")[qproj.] Mostly, this means working on dev tools for bevy. In the past month alone I've completed work on #link("https://github.com/ada-x64/psync")[psync] to synchronize work between my desktop server and my laptop, and began work on #link("https://github.com/ada-x64/bevy-command-prompt")[a bevy-native dev console.] Alongside psync has come a significant amount of work setting up a custom #link("https://jellyfin.org")[jellyfin]-based media center. I created a #link("https://github.com/ada-x64/homelab")[full-stack PWA] to monitor and navigate my homelab, all of which is available through a public domain, secured with zerotier ethernet-over-LAN, and running through a docker-compose instance on my personal machine. I'll have to write more about them now that I've found myself with time while everybody celebrates the holidays.

Speaking of free time, I've been putting in some effort to take breaks from manically pounding out code to avoid the sense of impending doom. I recently starting chewing through Patrick Jagoda's dense _#link("http://patrickjagoda.com/books/experimental-games")[Experimental Games]_ and have been brushing up on Deleuze and Guatarri. I have always been disappointed in the direction that English-language philosophy took since the linguistic turn in the early 20th century. Its sequestering of logic and reason to our linguistic faculties alone - logical positivism as the last truly scientific philosophy - and the isolation from Marxist thought, and thus the vital currents of continental philosophy, has done nothing for the field. It's been dried up and ruined, disconnected from the rest of the humanities in service to the United States' fetish for (military-industrial) technology. I only recently found out about the #link("https://pdfs.semanticscholar.org/010a/b00838b1a941d62399894942c9e740762859.pdf")[affective turn] in the humanities and social sciences - and only by reading outside of what is typically labelled 'philosophy.' I find it frustrating at best that my #link("https://aeon.co/essays/on-breaking-philosophy-out-of-the-seminar-and-back-into-the-world")[once-alive] home field has turned into a factory for Bayesian exegesis.
