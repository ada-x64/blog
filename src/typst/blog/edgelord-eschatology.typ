...
#show: post.with(
  title: "counteracting edgelord eschatology",
  description: "Against the very real cult of AI apocalypse.",
  date: datetime(year: 2025, month: 5, day: 2),
  tags: ("links", "ai", "politics"),
  aliases: none,
  draft: false,
  cover: none,
)
...
<the-endgame-of-edgelord-eschatology>
_#link("https://www.truthdig.com/author/emile-p-torres/")[Émile P. Torres] for TruthDig_
