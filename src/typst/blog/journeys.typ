...
#show: post.with(
  title: "journeys, but not for heros",
  description: "On the Hero's Journey and rice-boy",
  date: datetime(year: 2025, month: 5, day: 13),
...
_#link("https://aeon.co/users/eliane-glaser")[Eliane Glaser] for #link("https://aeon.co/")[Aeon]_
...
I'm fond of the approach discussed for _The Camera_ where the central character is only adjacent to the driving events of the plot. Similarly, the carrier bag theory offers a great basis for world-building.
...
== 3rd Voice 3rd Year
<rd-voice-3rd-year>
#youtube("https://www.youtube.com/embed/U7XiMjUq9To")

_Evan Dahm for his damn self_
...
#media(
  "/media/navichet.png",
  caption: [Navichet, from the 3rd Voice],
  linked: true,
)
