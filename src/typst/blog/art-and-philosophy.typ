...
#show: post.with(
  title: "philosophy is an aesthetic practice",
  description: "on alva noë, deleuze, and guatarri: why and how we do philosophy",
  date: datetime(year: 2026, month: 7, day: 1),
  tags: ("philosophy", "affect", "writing"),
  aliases: none,
  draft: false,
  cover: none,
)
...
Video games as a kind of mark-making (literal recording of bytes; data streams). But more importantly, philosophy as an aesthetic activity. And thus aesthetic activity as _meaning-making,_ as orienting, and habit-breaking.
