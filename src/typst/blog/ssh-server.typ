...
#link(
  "https://bsky.app/profile/cubething.dev/post/3lmxit4rnys2k",
)[Bluesky] #link("https://github.com/ada-x64/qproj/pull/4")[Github PR]
...
#media(
  "/media/ssh-server-excalidraw.png",
  caption: [Excalidraw image detailing the SSH server I built. See the PR linked above for more details.],
  linked: true,
)
