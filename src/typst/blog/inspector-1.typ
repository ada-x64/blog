...
<intro>
#media(
  "/media/inspector-1/editor.png",
  alt: "Editor.",
  caption: [Screenshot of the editor. The game view is in the center, featuring a capsule and a red wireframe of a sphere with an arrow pointing toward the capsule. In the upper-right corner there is a gizmo showing the XYZ axes in worldspace. Framing the game view are three docked panels: the hierarchy with all the entities in the scene, the inspector with details of the highlighted entity (Player), and the bottom tray with tabs for Resources, Assets, and States.],
  linked: true,
)

#link(
  "https://github.com/ada-x64/qproj/pull/2",
)[I _finally_ got player interactions working.]
...
#callout(
  kind: "note",
  title: [General codebase architecture],
)[In addition to building out a UI, I've been playing around trying to figure out the best way to organize my code. Games are big projects and I have _got_ to be clear about what I'm doing, especially given time and attention constraints. I've settled on #link("/blog/architecture-1.html")[a fairly simple architecture.] Click on that link to learn more, it's got a tl;dr and everything :)]
